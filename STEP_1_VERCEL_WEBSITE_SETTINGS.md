...
**Task:** Configure Website project in Vercel dashboard  
...
2. **Set Build Command**
   ...
   - Clear if needed
   - Enter: `npm run build`
   - This tells Vercel to use Next.js build
...
2. **Set Output Directory**
   ...
   - Clear if needed
   - Enter: `.next`
   - This is where Next.js stores build output
...
Look for a page that looks like this:
...
1. Confirm with message: "✅ Step 1 Complete"
2. Will proceed to Step 2 (Console Project Settings)
